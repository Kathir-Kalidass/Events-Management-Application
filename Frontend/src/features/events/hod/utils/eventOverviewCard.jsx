...
const EventOverviewCard = ({ event, activePage, setActivePage }) => {
  ...
  function approveEvent(id) {
    ...
    fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://10.5.12.1:4000/api'}/hod/event/approve`, {
      method: "PUT",
      headers: {
  ...
  function rejectEvent(id) {
    ...
    fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://10.5.12.1:4000/api'}/hod/event/reject`, {
      method: "PUT",
      headers: {
        "Authorization": `Bearer ${token}`,
        "Content-Type": "application/json",
