...
export const submitClaim = asyncHandler(async (req, res) => {
  try {
    ...
    // ✅ FIXED: Process expenses as PENDING, not auto-approved
    const processedExpenses = expenses.map(expense => {
      ...
      return {
        ...
        itemStatus: 'pending', // ✅ FIXED: Set as pending for HOD approval
        rejectionReason: '',
        receiptNumber: null,
        receiptGenerated: false,
        reviewDate: null, // ✅ FIXED: No review date until actually reviewed
        reviewedBy: null // ✅ FIXED: No reviewer until actually reviewed
      };
    });
    ...
    // ✅ FIXED: Update event with claim bill - set totalApprovedAmount to 0 for pending items
    const updatedEvent = await Event.findByIdAndUpdate(eventId, { 
      ...
      'claimBill.totalApprovedAmount': 0, // ✅ FIXED: Set to 0 since all items are pending
